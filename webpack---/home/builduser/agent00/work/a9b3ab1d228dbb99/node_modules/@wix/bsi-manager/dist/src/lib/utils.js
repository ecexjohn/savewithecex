...
exports.writeCookie = function(name, value, expires, path) {
    var cookie = name + "=" + value + "; expires=" + new Date(expires).toUTCString() + "; path=" + path + "; SameSite=None; Secure";
    try {
        window.document.cookie = cookie;
    } catch (e) {}
};
exports.destroyCookie = function(name, path) {
    exports.writeCookie(name, null, 0, path);
};
