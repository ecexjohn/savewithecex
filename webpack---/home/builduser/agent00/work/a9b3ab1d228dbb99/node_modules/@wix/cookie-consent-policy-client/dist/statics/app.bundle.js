...
(function(modules) { // webpackBootstrap
    ...
    /******/
    __webpack_require__.p = "https://static.parastorage.com/services/cookie-consent-policy-client/1.224.0/";
    /******/
    /******/
    ...
    (function(module, __webpack_exports__, __webpack_require__) {
        ...
        function isSameDomain(candidate, hostname) {
            ...
            return (hostname === candidate ||
                hostname.indexOf("." + candidate) === hostname.replace("." + candidate, '').length);
        }
        ...
        function getCookieData() {
            var regex = "[;\\s ]?" + COOKIE_NAME + "=([\\S]+(?:;?))";
            var cookieData = document.cookie.match(regex);
            var match = cookieData ? cookieData.pop() : void 0;
