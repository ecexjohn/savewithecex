...
var conduction_method_1 = require("../conduction-method");
...
var checkConductionMethod = function(conductionMethod) {
    return Object.keys(conduction_method_1.ConductionMethod).filter(function(cm) {
            return conduction_method_1.ConductionMethod[cm] === conductionMethod;
        }).length > 0 ?
        conductionMethod :
        undefined;
};
