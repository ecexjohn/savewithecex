import { PlatformEnvData, PlatformUtils, WixCodeSdkFactoryData } from '@wix/thunderbolt-symbols'
import {
	namespace,
	WixEventsWixCodeSdkFactoryInitialState,
	WixEventsWixCodeSdkHandlers,
	WixEventsWixCodeSdkWixCodeApi,
} from '..'
...
export function WixEventsSdkFactory(
	__: WixEventsWixCodeSdkFactoryInitialState & WixCodeSdkFactoryData,
	handlers: WixEventsWixCodeSdkHandlers,
	{ sessionServiceApi }: PlatformUtils,
	{ url }: PlatformEnvData
): { [namespace]: WixEventsWixCodeSdkWixCodeApi } {
	const getRequestHeaders = () => ({
		Authorization: sessionServiceApi.getInstance(EVENT_APP_DEF_ID),
