...
export var UrlBuilder = function(siteModels, isStagingRequest) {
    ...
    var buildSiteModelQueryParams = function(siteModels) {
        ...
        var _b = siteModels.sitePagesModel,
            ...
            dataFixerCacheVersion = _b.dataFixerCacheVersion;
        var requiredParams = {
            dfVersion: dataFixerVersion,
            dfCk: dataFixerCacheVersion,
            isHttps: isHttps,
        ...
        return __assign(__assign(__assign({}, requiredParams), (experimentsParam(experiments))), csmCacheKeyParam);
    };
    ...
    var siteAssetsParams = function(request) {
        ...
        var siteModelQueryParams = buildSiteModelQueryParams(siteModels);
