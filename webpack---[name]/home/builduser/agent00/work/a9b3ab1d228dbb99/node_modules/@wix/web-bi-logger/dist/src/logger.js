    ...
    Factory.prototype.logger = function(options) {
        ...
        return {
            log: function(paramsOrEventName, contextOrParams, contextOrUndefined) {
                ...
                var _a = exports.resolveLogArgs(paramsOrEventName, contextOrParams, contextOrUndefined),
                    eventName = _a[0],
                    params = _a[1],
                    context = _a[2];
