...
export function fillInPatternBlob(patternBlob, context) {
    ...
    blob.tags = blob.tags
        .map(function(_a) {
            ...
            return __assign(__assign(__assign(__assign({}, tag), (tag.props !== undefined ?
                {
...
export function fillPatternValue(value, context, tags, referencePath) {
    ...
    return isStructuredData(value) ?
        resolveStructuredData(patternValue) :
        patternValue;
...
function isStructuredData(value) {
    return value.includes("\"@context\": \"https://schema.org");
}
