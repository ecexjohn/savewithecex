...
function updateValueByIdentifier(data, identifier, value, meta) {
    if (data === void 0) {
        data = {};
    }
    var tags = (data && data.tags) || [];
    var updatedTags = updateValue(tags, identifier, value, meta);
...
function setTitle(data, title) {
    return updateValueByIdentifier(data, EXTERNAL_IDENTIFIERS.TITLE, title);
}
...
function setDescription(data, description) {
    return updateValueByIdentifier(data, EXTERNAL_IDENTIFIERS.DESCRIPTION, description);
}

function setCanonical(data, canonical) {
    return updateValueByIdentifier(data, EXTERNAL_IDENTIFIERS.CANONICAL, canonical);
}

function setIndexable(data, indexable) {
    return updateValueByIdentifier(data, EXTERNAL_IDENTIFIERS.ROBOTS, indexable ? 'index' : 'noindex');
}
