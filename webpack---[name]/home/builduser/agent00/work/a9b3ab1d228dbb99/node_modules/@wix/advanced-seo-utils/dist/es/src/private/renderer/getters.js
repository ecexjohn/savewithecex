...
function getTitle(data) {
    return getValueByIdentifier(data, EXTERNAL_IDENTIFIERS.TITLE);
}

function getDescription(data) {
    return getValueByIdentifier(data, EXTERNAL_IDENTIFIERS.DESCRIPTION);
}
...
function getSchemas(_a) {
    var tags = (_a === void 0 ? {} : _a).tags;
    return getSchemasArray(tags);
}
...
function getStaticMarkup(tags) {
    return renderToStaticMarkup(tags).join('\n');
}
export {
    addMetaTag,
    getCanonical,
